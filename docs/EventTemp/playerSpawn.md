...
execute as @a[tag=capi:spawn_initial] run tellraw @s {"text":"スターターキットを受け取りました！","color":"green"}

# 初回参加記念品
execute as @a[tag=capi:spawn_initial] run give @s diamond 1
execute as @a[tag=capi:spawn_initial] run tellraw @s {"text":"初回参加特典：ダイヤモンド×1","color":"aqua"}
```
...
# スポーン位置を表示
execute as @a[tag=capi:spawn] run tellraw @s [{"text":"スポーン位置: ","color":"gray"},{"score":{"name":"@s","objective":"capi:spawn_x"}},{"text":", "},{"score":{"name":"@s","objective":"capi:spawn_y"}},{"text":", "},{"score":{"name":"@s","objective":"capi:spawn_z"}}]
```
...
execute as @a[tag=capi:spawn] run title @s subtitle {"text":"10秒間無敵状態","color":"gold"}
execute as @a[tag=capi:spawn] run title @s title {"text":"リスポーン保護","color":"yellow"}
```
...
execute as @a[tag=capi:spawn_initial] run tellraw @s [{"text":"===== チュートリアル =====\n","color":"gold","bold":true},{"text":"サーバーへようこそ！\n基本的な操作を学びましょう。","color":"yellow","bold":false}]
...
# マイルストーン
execute as @a[tag=capi:spawn,scores={spawn_count=10}] run tellraw @s {"text":"10回目のスポーン！","color":"green"}
execute as @a[tag=capi:spawn,scores={spawn_count=100}] run tellraw @s {"text":"100回目のスポーン達成！","color":"gold"}
```
...
```mcfunction
execute as @a[tag=capi:spawn_initial] run tellraw @s [{"text":"\n===== サーバールール =====\n","color":"red","bold":true},{"text":"1. 他のプレイヤーを尊重しましょう\n","color":"white","bold":false},{"text":"2. グリーフィング禁止\n","color":"white"},{"text":"3. チート・改造クライアント禁止\n","color":"white"},{"text":"4. 楽しくプレイしましょう！\n","color":"green"}]
...
execute as @a[tag=capi:spawn_initial] run tellraw @s {"text":"ランダムな場所にスポーンしました！","color":"yellow"}
...
execute as @a[tag=capi:spawn,scores={capi:spawn_x=-100..100,capi:spawn_z=-100..100}] run tellraw @s {"text":"アリーナバトルスタート！","color":"red","bold":true}
```
