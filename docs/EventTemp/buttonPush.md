...
execute as @a[tag=capi:button,scores={capi:button_x=0,capi:button_y=64,capi:button_z=0}] run tellraw @s {"text":"ワープしました！","color":"green"}

# ショップのボタン（座標: 50, 64, 50）
execute as @a[tag=capi:button,scores={capi:button_x=50,capi:button_y=64,capi:button_z=50}] run tellraw @s {"text":"ショップへようこそ！","color":"gold"}
```
...
execute as @a[tag=capi:button,scores={capi:button_x=10,capi:button_y=64,capi:button_z=10}] run tellraw @s {"text":"ドアを開きました","color":"green"}
...
```mcfunction
# ゲーム開始ボタン
execute as @a[tag=capi:button,scores={capi:button_x=0,capi:button_y=70,capi:button_z=0}] run tellraw @a {"text":"ミニゲームを開始します！","color":"gold","bold":true}
...
execute as @a[tag=capi:button,scores={capi:button_x=10,capi:button_y=64,capi:button_z=0}] run tellraw @s {"text":"賛成票を投じました","color":"green"}
...
execute as @a[tag=capi:button,scores={capi:button_x=-10,capi:button_y=64,capi:button_z=0}] run tellraw @s {"text":"反対票を投じました","color":"red"}

# 投票結果を表示
execute as @a[tag=capi:button] run tellraw @a [{"text":"現在の投票: 賛成 ","color":"yellow"},{"score":{"name":"vote","objective":"yes"},"color":"green"},{"text":" vs 反対 "},{"score":{"name":"vote","objective":"no"},"color":"red"}]
```
...
execute as @a[tag=capi:button,scores={capi:button_y=64}] run tellraw @s {"text":"1階に移動しました","color":"green"}

# 2階ボタン（Y=70）
execute as @a[tag=capi:button,scores={capi:button_y=70}] run tp @s ~ 70 ~
execute as @a[tag=capi:button,scores={capi:button_y=70}] run tellraw @s {"text":"2階に移動しました","color":"green"}

# 3階ボタン（Y=76）
execute as @a[tag=capi:button,scores={capi:button_y=76}] run tp @s ~ 76 ~
execute as @a[tag=capi:button,scores={capi:button_y=76}] run tellraw @s {"text":"3階に移動しました","color":"green"}
```
...
execute as @a[tag=capi:button,scores={button_cooldown=0}] run tellraw @s {"text":"機能を実行しました","color":"green"}
execute as @a[tag=capi:button,scores={button_cooldown=0}] run scoreboard players set @s button_cooldown 100

# クールダウン中のプレイヤー
execute as @a[tag=capi:button,scores={button_cooldown=1..}] run tellraw @s {"text":"クールダウン中です...","color":"red"}
...
execute as @a[tag=capi:button,scores={capi:button_x=20,capi:button_y=64,capi:button_z=20,daily_claimed=0}] run tellraw @s {"text":"デイリー報酬を受け取りました！","color":"gold"}
...
# 既に受け取り済み
execute as @a[tag=capi:button,scores={capi:button_x=20,capi:button_y=64,capi:button_z=20,daily_claimed=1}] run tellraw @s {"text":"今日の報酬は既に受け取りました","color":"red"}
```
...
execute as @a[tag=capi:button,scores={capi:button_x=30,capi:button_y=64,capi:button_z=30},tag=vip] run tellraw @s {"text":"VIPエリアへようこそ","color":"gold"}

# VIPでない場合
execute as @a[tag=capi:button,scores={capi:button_x=30,capi:button_y=64,capi:button_z=30},tag=!vip] run tellraw @s {"text":"このエリアにはVIP権限が必要です","color":"red"}
...
execute as @a[tag=capi:button,scores={capi:button_x=0,capi:button_y=64,capi:button_z=10}] run tellraw @a [{"text":"このボタンは ","color":"yellow"},{"score":{"name":"button_counter","objective":"count"},"color":"gold"},{"text":" 回押されました","color":"yellow"}]

# 100回でイベント発生
execute if score button_counter count matches 100 run tellraw @a {"text":"100回達成！特別イベント開始！","color":"gold","bold":true}
