    ...
    items: [
      {
        ...
        media: '/showcase/scriptevent/explosion.mp4'
      },
      {
        label: 'Actionbar',
        desc: 'アクションバーに名前を表示',
        code: '/scriptevent capi:actionbar Hello <!name>',
        media: '/showcase/scriptevent/actionbar.mp4'
      },
      {
        label: 'Form',
    ...
    items: [
      {
        ...
        media: '/showcase/event/break_block.mp4'
      },
      {
        label: 'Projectile',
        ...
        media: '/showcase/event/projectile_hit.mp4'
      },
      {
        label: 'Item Use',
        desc: 'アイテムを使用した瞬間を検知',
